...
int main (int argc, char* argv[])
{
	...
	if (argc !=3)
	{
		cout << "rotOptSolvent <inFile.pdb> <outFile.pdb>" << endl;
		exit(1);
	}
	...
	cout << endl << "\t*rotOptSolvent*" << endl << endl << "Starting Energy is: " << _prot->intraSoluteEnergy(true) << endl << endl << "Optimization running..." << endl;
	_prot->rotOptSolvent(500);
